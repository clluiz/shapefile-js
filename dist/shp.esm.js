...
try{let r=()=>new DecompressionStream("deflate-raw"),t=e=>new Response(e);r(),l=e=>t(t(e).body.pipeThrough(r())).arrayBuffer().then(o=>new Uint8Array(o));}catch{}var l,w=new TextDecoder,c=r=>{throw Error("but-unzip~"+r)};function*p(r,t=l){let e=r.length-21,o=e-65536,u=new DataView(r.buffer,r.byteOffset),a=n=>u.getUint16(n+e,1),f=n=>u.getUint32(n+e,1),i=(n,d)=>r.subarray(e+=n,e+=d);for(;e>o&&(e=r.lastIndexOf(80,e-1))+1&&(r[e+1]-75||r[e+2]-5||r[e+3]-6););for(e<0&&c(2),o=a(10),o-a(8)&&c(3),e=f(16);o--;){let n=a(10),d=a(28),y=a(30),h=a(32),b=f(20),m=f(42),g=w.decode(i(46,d)),x=w.decode(i(y,h)),U=e,s;e=m,s=i(30+a(26)+a(28),b),yield {filename:g,comment:x,read:()=>n-8?n?c(1):s:t(s)},e=U;}}
...
const parseZip = async function (buffer, whiteList, options) {
  let key;
...
const getShapefile = async function (base, whiteList, options) {
  const defaultEncoding = resolveDefaultEncoding(options);
...
export { combine, getShapefile as default, getShapefile, _parseDbf as parseDbf, _parseShp as parseShp, parseZip, resolveDefaultEncoding };
